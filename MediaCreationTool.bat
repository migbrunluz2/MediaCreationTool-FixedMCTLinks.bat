...
:: Fixed dead links for 1507,1511,1607,18 downloads via using Wayback Machine links,may not work at times
:: If you are using Windows 7 you need to enable TLS 1.2/1.3 & update Powershell to v7.1.0
...
set "EXE=https://web.archive.org/web/20191010094142id_/https://software-download.microsoft.com/download/pr/MediaCreationTool1809.exe"
...
set "EXE=https://web.archive.org/web/20190209104435id_/https://software-download.microsoft.com/download/pr/MediaCreationTool1803.exe"
...
set "EXE=https://web.archive.org/web/20200528095636id_/https://wscont.apps.microsoft.com/winstore/OSUpgradeNotification/MediaCreationTool/prod/Products_20170116.cab"
...
set "XML=https://web.archive.org/web/20200528095658id_/https://wscont.apps.microsoft.com/winstore/OSUpgradeNotification/MediaCreationTool/prod/Products05242016.xml"
...
set "XML=https://web.archive.org/web/20200528095729id_/https://wscont.apps.microsoft.com/winstore/OSUpgradeNotification/MediaCreationTool/prod/Products09232015_2.xml"
